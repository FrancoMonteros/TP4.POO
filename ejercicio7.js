...
aniadirContacto(Contacto): Añade un contacto a la agenda, sino la agenda no puede almacenar más 
contactos indicar por pantalla.
...
class Contacto{
    ...
    ContactoInfo(){
        document.write(`Nombre: ${thi.nombre} Tel: ${this.telefono}`)
    }
}
class AgendaTel extends Contacto{
    constructor(nombre, telefono,longitud){
